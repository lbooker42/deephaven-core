...
public class BigDecimalRollingCountOperator extends BaseLongUpdateByOperator {
    ...
    protected class Context extends BaseLongUpdateByOperator.Context {
        ...
        protected ObjectRingBuffer<BigDecimal> buffer;
        ...
        public void pop(int count) {
            ...
            for (int ii = 0; ii < count; ii++) {
                final BigDecimal val = buffer.removeUnsafe();
    ...
    public BigDecimalRollingCountOperator(
        ...
        countFunction = AggCountType.getBigDecimalCountFunction(countType);
    }

    @Override
    public UpdateByOperator copy() {
        return new BigDecimalRollingCountOperator(
                pair,
                affectingColumns,
                timestampColumnName,
