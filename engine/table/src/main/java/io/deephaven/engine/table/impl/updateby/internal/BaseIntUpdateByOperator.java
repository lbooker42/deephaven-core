...
public abstract class BaseIntUpdateByOperator extends UpdateByOperator {
    protected WritableColumnSource<Integer> outputSource;
    protected WritableColumnSource<Integer> maybeInnerSource;
     ...
     *        of this operator.
     */
    public BaseIntUpdateByOperator(
