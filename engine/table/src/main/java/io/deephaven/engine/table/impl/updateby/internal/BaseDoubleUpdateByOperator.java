...
public abstract class BaseDoubleUpdateByOperator extends UpdateByOperator {
    protected WritableColumnSource<Double> outputSource;
    protected WritableColumnSource<Double> maybeInnerSource;
