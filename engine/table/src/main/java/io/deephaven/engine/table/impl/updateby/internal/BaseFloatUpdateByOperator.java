...
public abstract class BaseFloatUpdateByOperator extends UpdateByOperator {
    protected WritableColumnSource<Float> outputSource;
    protected WritableColumnSource<Float> maybeInnerSource;
