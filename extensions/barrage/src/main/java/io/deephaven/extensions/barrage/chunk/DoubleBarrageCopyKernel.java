...
public class DoubleBarrageCopyKernel {
    ...
    private static class DoubleBarrageCopyKernelContext implements BarrageCopyKernel {
        @Override
        public void copyFromDeltaChunks(
                ...
                final WritableChunk<Values>[][] modChunks,
                final int deltaChunkSize) {
            DoubleBarrageCopyKernel.copyFromDeltaChunks(
                    mapping, dest.asWritableDoubleChunk(), addChunks, modChunks, deltaChunkSize);
        }
    }

    public static final BarrageCopyKernel INSTANCE = new DoubleBarrageCopyKernelContext();
}
