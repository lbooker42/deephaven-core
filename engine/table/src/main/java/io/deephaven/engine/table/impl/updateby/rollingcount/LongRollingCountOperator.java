...
public class LongRollingCountOperator extends BaseLongUpdateByOperator {
    ...
    private final AggCountType.LongCountFunction countFunction;
    ...
    public LongRollingCountOperator(
        ...
        countFunction = AggCountType.getLongCountFunction(countType);
    }

    @Override
    public UpdateByOperator copy() {
        return new LongRollingCountOperator(pair,
                affectingColumns,
                timestampColumnName,
